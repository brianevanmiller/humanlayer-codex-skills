...
metadata:
  short-description: Read a PR and generate a rich description file + update GitHub
---
...
## Important notes:
- This skill works across different repositories - always read the local template
